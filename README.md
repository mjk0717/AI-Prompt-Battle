...
스마트폰 클라이언트와 PC 매니저가 함께 사용하는 팀전 프롬프트 게임입니다.
...
- 닉네임 입력 후 기존 세션이 있으면 바로 기존 세션 참여
- 해당 닉네임의 진행 중 세션이 없으면 새 참가 세션 생성
...
- 로컬 포함된 JavaScript 라이브러리의 라이선스 및 출처: `THIRD_PARTY_NOTICES.md`
